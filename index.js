//consts
const apikey = "0ea63277d6e727022fa47ab96fa1662a";
...
const apiPaths ={
    ...
    searchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyDUat3KtiDOH-g_-f41ORPBZbtDIuEfi5E`,
}
//boots up the app
function init(){
    fetchTrendingMovies();
